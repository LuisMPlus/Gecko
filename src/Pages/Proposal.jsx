...
const PROTOTIPO_CONTENT = {
  ...
  escaneo: {
    ...
    fundamento: {
      ...
      detalles:
        "El sistema utiliza dos números para definir cada diente: uno para el cuadrante y otro para el diente según su cuadrante. Todo esto permite al programa identificar fácilmente el historial dental, y así poder transformarlo en un archivo digital, cumple con la notación FDI.",
    },
  },
};
