...
export const gradients = {
  avatar: "linear-gradient(135deg, #F69055 0%, #223768 100%)",
  badge: "linear-gradient(135deg, #F69055 0%, #223768 100%)",
  overlay: "linear-gradient(135deg, #F69055 0%, #80b7c3 50%, #e0ff4f 100%)",
  decorative: "linear-gradient(90deg, #F69055 0%, #80b7c3 50%, #e0ff4f 100%)",
};

export const shadows = {
  default: "0 4px 6px -1px rgba(0, 0, 0, 0.1)",
  hover:
    "0 25px 50px -12px rgba(34, 55, 104, 0.25), 0 0 0 1px rgba(128, 183, 195, 0.3)",
};
